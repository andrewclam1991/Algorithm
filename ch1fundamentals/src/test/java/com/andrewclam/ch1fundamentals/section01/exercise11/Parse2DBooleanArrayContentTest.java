...
public class Parse2DBooleanArrayContentTest {
  ...
  public void init() {
    ...
    System.out.print(Parse2DBooleanArrayContent.getRequirement() + "\n");
  }
  ...
  public void testPrintResult(){
    ...
    String result1 = Parse2DBooleanArrayContent.fun(mRandomTestArray1);
    String result2 = Parse2DBooleanArrayContent.fun(mTestArray1);
    String result3 = Parse2DBooleanArrayContent.fun(mTestArray2);
  ...
  public void testWithEmptyArray(){
    ...
    // When such array is provided to the method
    String result = Parse2DBooleanArrayContent.fun(mEmptyArray);
